            ...
            <div class="panel panel-flat timeline-content">
                ...
                <div class="panel-body">
                    <a href="#" class="display-block content-group">
                        <img src="{{ asset('admin') }}/assets/images/cover.jpg" class="img-responsive content-group" alt="">
                    </a>
                    ...
                    <ul class="media-list chat-list content-group">
                        ...
                        <li class="media reversed">
                            ...
                            <div class="media-right">
                                <a href="{{ asset('admin') }}/assets/images/placeholder.jpg">
                                    <img src="{{ asset('admin') }}/assets/images/placeholder.jpg" class="img-circle" alt="">
                                </a>
                            </div>
                        </li>
