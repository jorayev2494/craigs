        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown language-switch">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="ukrainian">
                            <img src="assets/images/flags/ua.png" alt="">
                            Українська
                        </a>
                    </li>
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-content width-350">
                    ...
                    <ul class="media-list dropdown-content-body">
                        ...
                        <li class="media">
                            <div class="media-left">
                                <img src="{{ asset('admin') }}/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
                            <div class="media-body">
                                <a href="#" class="media-heading">
                                ...
                                <span class="text-muted">What a strenuous career it is that Ive chosen...</span>
                            </div>
                        </li>
            ...
            <li class="dropdown dropdown-user">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li>
                        <a href="#"><span class="badge bg-teal-400 pull-right">58</span> <i class="icon-comment-discussion"></i> Messages</a>
                    </li>
