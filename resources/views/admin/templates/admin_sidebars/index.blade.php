                        ...
                        <tr class="text-center">
                            ...
                            <td class="text-center">
                                <center>
                                    <div class="btn">
                                        <a href="#">
                                            {!! Form::open(["url" => route("dashboard.destroy", ["slug" => $menu->slug]), "method" => "DELETE"]) !!}
                                    ...
                                    <div class="btn">
                                        <a href="{{ route('dashboard.show', ['slug' => $menu->slug]) }}" class="text-default pull-left">
                                            <i class="icon-eye"></i>
                                            Show
                                        </a>
                                    </div>
                                    ...
                                    <div class="btn">
                                        <a href="{{ route('dashboard.edit', ['slug' => $menu->slug]) }}" class="text-default pull-left">
                                            <i class="icon-pen6"></i>
                                            Edit
                                        </a>
                                    </div>
                                ...
                                {{-- <ul class="icons-list pull-left">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li>
                                                <a href="{{ route('dashboard.show', ['slug' => $menu->slug]) }}">
                                                    <i class="icon-eye"></i>
                                                    Show
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('dashboard.edit', ['slug' => $menu->slug]) }}">
                                                    <i class="icon-pen6"></i>
                                                    Edit
                                                </a>
                                            </li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#">
                                                <img src="{{ asset('admin') }}/assets/images/brands/facebook.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#">
                                                <img src="{{ asset('admin') }}/assets/images/brands/youtube.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                                            <div class="">
                                                <a href="#" class="text-default text-semibold">Youtube videos</a></div>
                                            <div class="text-muted text-size-small">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#">
                                                <img src="{{ asset('admin') }}/assets/images/brands/spotify.png" class="img-circle img-xs" alt="">
                                            </a>
                                        </div>
                                        <div class="media-left">
                                            <div class="">
                                    ...
                                    <td>
                                        <span class="text-muted">Diligence</span>
                                    </td>
                                    ...
                                    <td>
                                        <span class="label bg-grey-400">Hold</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#">
                                                <img src="{{ asset('admin') }}/assets/images/brands/twitter.png" class="img-circle img-xs" alt="">
                                            </a>
                                        </div>
                                        <div class="media-left">
                                            <div class="">
                                    ...
                                    <td>
                                        <span class="text-muted">Deluxe</span>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#">
                                                <img src="{{ asset('admin') }}/assets/images/brands/bing.png" class="img-circle img-xs" alt="">
                                            </a>
                                        </div>
                                        <div class="media-left">
                                            <div class="">
                                    ...
                                    <td>
                                        <span class="text-danger"><i class="icon-stats-decline2 position-left"></i> - 5.78%</span>
                                    </td>
                                        ...
                                        <ul class="icons-list">
                                            <li class="dropup">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li>
                                                        <a href="#">
                                                            <i class="icon-file-stats"></i> View statement
                                                        </a>
                                                    </li>

                                                    <li>
                                                        <a href="#">
                                                            <i class="icon-file-text2"></i> Edit campaign
                                                        </a>
                                                    </li>

                                                    <li>
                                                        <a href="#">
                                                            <i class="icon-file-locked"></i> Disable campaign
                                                        </a>
                                                    </li>
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#">
                                                <img src="{{ asset('admin') }}/assets/images/brands/amazon.png" class="img-circle img-xs" alt="">
                                            </a>
                                        </div>
                                        <div class="media-left">
                                            <div class="">
                                ...
                                <tr>
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ asset('admin') }}/assets/images/brands/dribbble.png" class="img-circle img-xs" alt=""></a>
                                        </div>
                                        <div class="media-left">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-left media-middle">
                                            <a href="#"><img src="{{ asset('admin') }}/assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="text-default display-inline-block">
                                            ...
                                            <span class="display-block text-muted">Resizes control labels font-size and account for the standard...</span>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <ul class="icons-list">
                                ...
                                <ul class="media-list content-group">
                                    <li class="media stack-media-on-mobile">
                                        <div class="media-left">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="{{ asset('admin') }}/assets/images/placeholder.jpg" class="img-responsive img-rounded media-preview" alt="">
